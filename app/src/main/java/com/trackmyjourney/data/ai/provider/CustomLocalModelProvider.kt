...
import com.trackmyjourney.data.ai.runtime.LiteRtRuntimeAdapter
import com.trackmyjourney.data.ai.runtime.LocalModelRuntime
import com.trackmyjourney.data.ai.runtime.MediaPipeLlmRuntimeAdapter
...
class CustomLocalModelProvider @Inject constructor(
    ...
    override fun isAvailable(): Boolean {
        ...
        return activeModel.localPath != null &&
                activeModel.installState == com.trackmyjourney.data.ai.models.ModelInstallState.INSTALLED &&
