...
class LocationTracker(
    ...
    companion object {
        ...
        private const val MAX_HIGH_SPEED_ACCEL = 6.0f
        ...
        fun filterSpeed(
            ...
            val crossValidated = minOf(gpsSpeedMs, calcSpeedMs * CROSS_VALIDATION_FACTOR)
            ...
            // 4. Exponential moving average against previous filtered speed
            val smoothed = SPEED_EMA_ALPHA * accelLimited + (1f - SPEED_EMA_ALPHA) * prevSpeedMs
