package com.trackmyjourney.data.repository
...
import com.trackmyjourney.data.ai.provider.AiProviderSelector
...
class TrackRepository(
    ...
    suspend fun addTrackPoint(
        trackId: String,
        location: Location,
        healthReading: com.trackmyjourney.data.bluetooth.WearableReading? = null
    ): TrackPoint? {
     ...
     */
    private suspend fun buildLifetimeContext(currentTrack: TrackSession): com.trackmyjourney.data.ai.provider.LifetimeContext? {
        return try {
            val stats = getStats()
            ...
            com.trackmyjourney.data.ai.provider.LifetimeContext(
