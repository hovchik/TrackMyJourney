package com.trackmyjourney.di

import android.content.Context
import androidx.room.Room
import com.trackmyjourney.data.ai.LocalAiEngine
import com.trackmyjourney.data.ai.models.*
import com.trackmyjourney.data.ai.runtime.*
import com.trackmyjourney.data.ai.provider.*
...
import com.trackmyjourney.data.location.SmartIntervalManager
import com.trackmyjourney.data.repository.TrackRepository
import com.trackmyjourney.data.webhook.WebhookSender
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideCloudProvider(aiPreferences: AiPreferences, settingsDataStore: SettingsDataStore) = CloudProvider(aiPreferences, settingsDataStore)
    ...
    ) = AiProviderSelector(aiPreferences, customLocalModelProvider, cloudProvider, settingsDataStore)
